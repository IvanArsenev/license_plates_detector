...
class YOLOModel:
    ...
    def demo(self, model_path, license_plate_class, video_path):
        """
    ...
    def train(self, data_path, model_path, results_path, epochs, batch_size, img_size):
        """
...
def main():
    ...
    if args.mode == "demo":
        if args.video_path is None:
            ...
            model.demo(args.model_path, args.license_plate_class, args.video_path)
